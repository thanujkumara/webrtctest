...
$('#master-button').click(async () => {
    ...
    getChannelEndpoint(formValues);
    //formValues.signedUrl = "wss://m-787070a8.kinesisvideo.us-east-1.amazonaws.com/?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-ChannelARN=arn%3Aaws%3Akinesisvideo%3Aus-east-1%3A228664984865%3Achannel%2Fef9cf66c91d42cc8c3fbb71005b65d4%2F1692728206389&X-Amz-Credential=AKIATKPL6YUQ7Q3M5AUR%2F20230822%2Fus-east-1%2Fkinesisvideo%2Faws4_request&X-Amz-Date=20230822T181650Z&X-Amz-Expires=299&X-Amz-SignedHeaders=host&X-Amz-Signature=c932719c6fd9edcd7fb749f33e3389f2d8ec1170c3808e38074137d87c429e51";
...
$('#viewer-button').click(async () => {
    ...
    //formValues.signedUrl = "wss://v-03ece791.kinesisvideo.us-east-1.amazonaws.com/?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-ChannelARN=arn%3Aaws%3Akinesisvideo%3Aus-east-1%3A228664984865%3Achannel%2Fef9cf66c91d42cc8c3fbb71005b65d4%2F1692728206389&X-Amz-ClientId=Thanuj&X-Amz-Credential=AKIATKPL6YUQ7Q3M5AUR%2F20230822%2Fus-east-1%2Fkinesisvideo%2Faws4_request&X-Amz-Date=20230822T181936Z&X-Amz-Expires=299&X-Amz-SignedHeaders=host&X-Amz-Signature=e9ac3b4a85ec6f6abd7b36e4740639df151d8e2ecc137763c88755dcb51b9c21";
...
function getChannelEndpoint(formValues){



    const bearerToken = $('#bearerToken').val();
    const url = "http://localhost:5206/StartStream/device/"+ formValues.channelName +"/client/"+ formValues.clientId;
      ...
      $.ajax({
        ...
        processData: true,
        headers: {
        'Access-Control-Allow-Origin': 'http://localhost:3001, http://localhost:3001/, localhost:3001',
        "Access-Control-Allow-Credentials": "true",
        'Access-Control-Allow-Methods': 'POST,GET,HEAD,OPTIONS,PUT,DELETE',
        'Access-Control-Allow-Headers': 'Access-Control-Allow-Headers, Access-Control-Allow-Origin, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, Authorization',
